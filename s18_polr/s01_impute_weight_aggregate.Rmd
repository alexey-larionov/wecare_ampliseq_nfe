...
last updated: Alexey Larionov, 06Sep2019
...
- *No need in inverting genotypes* because no variants with AFs > 0.5  
- Impute missed genotypes (2 x total AF = mean genotype, as "" in SKAT)  
- Weight variants by total AFs (beta[1,25], default weight in SKAT)  
- Aggregate preprocessed (inverted-imputed-weighted) variants per genes (just add: as in "burden" SKAT style)  

##Input & output data:  
- 164 variants (62 genes) x 667 samples (470BC = 233UBC + 237CBC and 197NFE)  
...
source_folder="/Users/alexey/Documents/wecare/ampliseq/v04_ampliseq_nfe/s17_crude_stats"
...
for(var in 1:nrow(genotypes_imp_wt.mx)){
  ...
  weight * genotypes_imp_wt.mx[var,] -> genotypes_imp_wt.mx[var,]
