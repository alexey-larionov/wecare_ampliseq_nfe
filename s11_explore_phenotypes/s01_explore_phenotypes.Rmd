...
No association of CBC with familial history (there was a trend only in WES)  

The only statisitically significant association with CBC was in the applied treatment:  
...
as if the treatment protected from CBC, and also might possibly be linked  
...
There was some outdated and occasionally unexpected hormonal treatment pratices:  
...
A significant association of CBC and UBC with sample number (t-test 0.04)  
...
My suggestion is NOT to include for compartibility with WES analysis  
...
base_folder="/Users/alexey/Documents/wecare/ampliseq/v04_ampliseq_nfe/s11_explore_phenotypes"
