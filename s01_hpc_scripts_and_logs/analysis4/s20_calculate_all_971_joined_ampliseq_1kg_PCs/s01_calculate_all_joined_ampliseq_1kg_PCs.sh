...
# s01_calculate_all_joined_ampliseq_1kg_PCs.sh
# Started: Alexey Larionov, 13Jul2019
# Last updated: Alexey Larionov, 14Jul2019

# Use:
# sbatch s01_calculate_all_joined_ampliseq_1kg_PCs.sh

# Calculate PCs for joined ampliseq-1kg dataset

# ------------------------------------ #
#         sbatch instructions          #
# ------------------------------------ #

#SBATCH -J s01_calculate_all_joined_ampliseq_1kg_PCs
...
#SBATCH --output=s01_calculate_all_joined_ampliseq_1kg_PCs.log
#SBATCH --ntasks=4
#SBATCH --qos=INTR
...
# Start message
echo "Calculate PCs for joined ampliseq-1kg dataset"
date
echo ""
...
data_folder="${data_folder}/s20_calculate_all_971_joined_ampliseq_1kg_PCs"
mkdir -p "${data_folder}"
...
LD_pruned_datset="${output_data_folder}/ampliseq_1kg_971_3219_not_in_LD"
...
pca_results="${pca_results_folder}/ampliseq_1kg_971_3219_100PCs"
...
echo "Calculated 100 top PCs using 971 avaialble variants not in LD"
echo ""
