...
# s01_calculate_not_rare_joined_ampliseq_1kg_PCs.sh
# Started: Alexey Larionov, 13Jul2019
# Last updated: Alexey Larionov, 14Jul2019

# Use:
# sbatch s01_calculate_not_rare_joined_ampliseq_1kg_PCs.sh

# Calculate PCs for joined ampliseq-1kg dataset (exclude rare variants)

# ------------------------------------ #
#         sbatch instructions          #
# ------------------------------------ #

#SBATCH -J s01_calculate_not_rare_joined_ampliseq_1kg_PCs
...
#SBATCH --output=s01_calculate_not_rare_joined_ampliseq_1kg_PCs.log
#SBATCH --ntasks=4
#SBATCH --qos=INTR
...
# Start message
echo "Calculate PCs for joined ampliseq-1kg dataset (exclude rare variants)"
date
echo ""
...
data_folder="${data_folder}/s19_calculate_not_rare_joined_ampliseq_1kg_PCs"
mkdir -p "${data_folder}"
...
common_variants="${output_data_folder}/ampliseq_1kg_394_3219_common"
...
LD_pruned_datset="${output_data_folder}/ampliseq_1kg_293_3219_not_in_LD"
...
pca_results="${pca_results_folder}/ampliseq_1kg_293_3219_100PCs"
...
echo "Calculated 100 top PCs using 293 non-rare variants not in LD"
echo ""
