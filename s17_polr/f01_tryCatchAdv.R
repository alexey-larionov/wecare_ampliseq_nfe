# Function for advanced handling of errors and warnings  
# Motivated by demo(error.catching)  
# Started: Alexey Larionov, 09Mar2017  
# Last updated: Alexey Larionov, 17Oct2017  
...
#    tryCatchAL(1/0)  # generates infinity value, rather than error  
...
# advTryCatch(1/2)  
# advTryCatch(1/"A")  
# advTryCatch(chisq.test(matrix(c(1,2,3,4,5,6), nrow=2)))  
# advTryCatch(1/0) # succeded - the result is num Inf !  
