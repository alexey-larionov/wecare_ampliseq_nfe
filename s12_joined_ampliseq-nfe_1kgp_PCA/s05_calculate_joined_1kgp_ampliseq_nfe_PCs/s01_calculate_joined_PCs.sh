...
# Start message
echo "Calculate PCs for joined 1kgp-ampliseq-nfe dataset (excluding rare variants and variants in LD)"
date
echo ""
...
data_folder="${base_folder}/s05_calculate_joined_1kgp_ampliseq_nfe_PCs/data"
rm -fr "${data_folder}"
mkdir -p "${data_folder}"

source_vcf="${base_folder}/s04_merge_1kgp_and_wecare_nfe_genotypes/data/s01_joined_1kgp_ampliseq_nfe_biallelic_snps_1101_3216.vcf.gz"
...
initial_plink_dataset="${plink_dataset_folder}/ampliseq_1kg_1101_3216"
...
common_variants="${output_data_folder}/ampliseq_nfe_1kgp_non_rare_394_3216"
...
LD_pruned_datset="${output_data_folder}/ampliseq_nfe_1kgp_non_rare_not_in_LD_293_3216"
...
pca_results="${pca_results_folder}/ampliseq_nfe_1kg_293_3216_100PCs"
...
echo "Calculated 100 top PCs for joined 1kgp and ampliseq-nfe dataset using 293 non-rare variants not in LD"
echo ""
