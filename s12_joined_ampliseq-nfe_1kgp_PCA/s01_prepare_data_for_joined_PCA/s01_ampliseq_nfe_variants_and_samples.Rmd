---
title: "s01_ampliseq_nfe_variants_and_samples"
...
Input and output data: 1,838 vars x 712 samples ( 515BC = 258UBC + 257CBC and 197NFE)  
...
hist(variants.df$init_AF, lab=T, ylim=c(0,1800))
hist(variants.df$kgen.AF, lab=T, ylim=c(0,1100))
...
file_name <- paste(base_folder,"data","s01_ampliseq_nfe_1838_vars.txt", sep="/")
...
samples_file <- paste(base_folder,"data","s01_ampliseq_nfe_712_samples.txt", sep="/")
